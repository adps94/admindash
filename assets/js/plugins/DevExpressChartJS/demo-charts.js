...
$("#pie-chart").dxPieChart({
     dataSource: [
                  { visitors: "delegates", count: 110 },
                  { visitors: "meeting", count: 100 },
                  { visitors: "interview", count: 72 },
                  { visitors: "guests", count: 47 },
                  { visitors: "courrier", count: 46 },
                  { visitors: "other", count: 41 }
                ],
    legend: {
        visible: false
    },
